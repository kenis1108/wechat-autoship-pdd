 ...
 * @LastEditTime: 2024-05-01 11:51:54
 ...
 * 7. 78790354608806 LENA GOH[5029] # 名字里带了空格的也需要做处理，妈了个巴子
 * 8. 78793100412763tracy Yu
 * 9. 78793100412763 tracy Yu
 * 10. 78790354608806 LENA GOH[5029] 78793100412763tracy Yu
 * 11. 78790354608806 LENA GOH[5029] 78793100412763 tracy Yu
 */
const input = [
  // `78779856323821   77[7105]`,
  // `78779855409756楊蕙慈`,
  // `78779856323821   77[7105]         78779855409756  楊蕙慈`,
  // `78793100412763tracy Yu`,
  // `78790354608806 LENA GOH[5029]`,
  // `78790354608806 LENA GOH[5029] 78793100412763tracy Yu`,
  `78793100412763 tracy Yu`,
  `78790354608806 LENA GOH[5029] 78793100412763 tracy Yu`
]
const matchETNTextWithRegForInputLists = (arr: string[]) => {
  arr.forEach(input => {
...
matchETNTextWithRegForInputLists(input)